...
public class SubscriptionResult
{
    ...
    /// <summary>
    /// Business order ID (stable key for PaymentRecordGAgent lookup).
    /// - Set from request metadata "order_id" if provided
    /// - Otherwise generated by provider and stored in platform metadata
    /// - Used consistently in both creation and webhook processing
    /// </summary>
