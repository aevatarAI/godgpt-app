...
public class GodGPTController : AevatarController
{
    ...
    // NOTE: chat_old method removed - was using deprecated Orleans Stream pattern
    // New streaming chat should use IAsyncEnumerable pattern from AIGAgentBase.ChatStreamAsync
